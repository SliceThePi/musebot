...
class CharacterList {
  constructor(filename) {
    this.stats = ["Dexterity", "Agility", "Strength", "Size", "Endurance", "Perception", "Intelligence", "Wisdom", "Charisma", "Composure"];
  ...
  save(){
    jsonfile.writeFile(this.filename, this.list, (err)=>{console.log(err || "Successfully saved characters.");});
  }
  ...
  search(name){
    return this.get(didYouMean(name, this.list, "name"));
  }
}
